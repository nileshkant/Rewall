...
class CategoryImageScreen extends React.Component {
  static navigationOptions =({ navigation }) => ({
    title: navigation.state.params ? navigation.state.params.categoryName : null
  })
...
export default connect(
  mapStateToProps,
  mapDispatchToProps)(CategoryImageScreen)
